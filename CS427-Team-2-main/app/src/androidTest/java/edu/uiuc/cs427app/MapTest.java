...
/**
 * Test class for verifying map-related functionalities.
 * This class tests the addition of cities and the functionality of the "Map" button.
 */
...
public class MapTest {
    ...
    /**
     * Tests that the "Map" button opens the WeatherActivity for the added cities.
     * @throws InterruptedException if the thread sleep is interrupted
     */
    @Test
    public void testMapButtonOpensWeatherActivity() throws InterruptedException {
        onView(allOf(
